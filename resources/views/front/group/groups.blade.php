                                ...
                                <div class="row g-2">
                                    <div class="col-md-9 col-sm-8">
                                        <div class="search-input-box position-relative">
                                            ...
                                            <input type="text" name="search" placeholder="Search for a group" class="search-inp" value="">
                                            <button type="submit" class="g-search-btn"><i class="fas fa-search"></i></button>
                                            {!! Form::close() !!}
                                        </div>
                                        <div class="quick-links">
                                            <a href="{{url('/group')}}">overview</a>
                                            <a href="{{url('/groups')}}"  class="active">browse</a>
                                    ...
                                    <div class="col-md-3 col-sm-4">
                                       <div class="search-and-browse-btn">
                                        <a href="{{url('/creategroup')}}">Start a New Group</a>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="group-box">
                                            <a href="{{url('/discussion/'.$group->group_id)}}">
                                                <?php /*<img src="{{$group->user->smallthumbimagefilepath}}" alt="{{$group->user->username}}" class="group-members-avtar">*/?>
