        ...
        <div class="container-xl">
            <div class="casualencounters-w-wrap">
                <div class="group-discussion-bg">
                    ...
                    <div class="topic-tabing-section">
                        <div class="topic-tabing-row">
                            {{-- <div class="topic-tab-menu-area">
                                <ul class="nav nav-tabs topic-tab-menu-group">
                                    <li><a href="#about_rules" data-bs-toggle="tab" role="tab">About & Rules</a>
                                    </li>
                                    <li><a href="#discussions" class="active" data-bs-toggle="tab" role="tab">Discussions</a></li>
                                    <li><a href="#members_num" data-bs-toggle="tab" role="tab">{{number_format($group_member_count)}} Members</a></li>
                                </ul>
                            </div> --}}
                            <div class="tab-content topic-tab-content-area w-100">
                                <div class="tab-pane fade " id="about_rules" role="tabpanel">
                                    <div class="changes-and-new-features-msg">
                                ...
                                <div class="tab-pane fade" id="members_num" role="tabpanel">
                                    <div class="all-members-area pb-0">
                                        <div class="row g-3">
                                        @if(!$group->members->isEmpty())
                                            ...
                                            <div class="col-md-6 col-12">
                                                ...
                                                <div class="friend-box">
                                                    <div class="fri-img">
                                                        <a href="{{url('/profile/'.$member->user_id)}}">
                                                            <img src="{{$member->user->smallthumbimagefilepath}}" alt="user-img">
                                                        </a>
                                                    </div>
                                                    <div class="fri-info">
                                                        <div class="fri-name">
                                                            <a href="{{url('/profile/'.$member->user_id)}}">{{$member->username}}</a>
                                                            <span class="age">{{ Carbon\Carbon::parse($member->dob)->age }} {{ $member->gender }}</span>
                                                        </div>
                                                        <div class="fri-details">
                                                            <p><b>Relationship Status:</b> {{$member->relationship_status}}</p>
                                                            <p><b>Orientation:</b> {{$member->sexual_orientation}}</p>
                                                            <p><b>Location:</b> {{string_explode_implode($member->address)}}</p>
                                                            <p><b>Role:</b> {{$member->role}}</p>
                                                        </div>
                                                    </div>
                                                    <div class="fri-btn">
                                                        <a href="{{url('/user-images/'.$member->user_id)}}" class="fri-btn-item">{{$member->user->userimages()->count()}} Images</a>
                                                        <a href="{{url('/user-video/'.$member->user_id)}}" class="fri-btn-item">{{$member->user->uservideos()->count()}} Videos</a>
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
