                        ...
                        <div class="profile-tabs-block">
                            <div class="profile-setting-box" id="profileSetting">
                                <ul class="profile-setting-group">
                                    ...
                                    <li><a href="{{ url('/upload-image') }}" class="profile-setting-menu active-menu">Upload
                                            Photos</a></li>
                            ...
                            <div class="common-row">
                                <div class="common-left-column">
                                    <div class="upload-photo-bg">
                                        ...
                                        {!! Form::open(['url' => 'upload-image', 'id' => 'uploadimage_form', 'class' => 'uploadimage_form']) !!}
                                        <div class="upload-photo-area">
                                            ...
                                            <div class="caption-box">
                                                ...
                                                <div class="radio-btn-box">
                                                    <span class="this-image-for">This image is for:</span>
                                                ...
                                                <div class="form-group certify-everyone-checkbox">
                                                    <label class="role-checkbox"> I certify that everyone in this image is
                                                        over 18 years of age at the time this photo was taken, and one of
                                                        the following applies: <br> - This picture is of me. <br> - This
                                                        picture was taken by me. <br> - I have permission to use this image.
                                                        <input class="form-control d-none" value="1" type="checkbox"
                                                            name="tnc">
                                                        <span class="checkmark-arrow"></span>
                                                    </label>
                                                </div>
                                                <input type="submit" value="Add New Image" class="add-new-image-btn">
                                ...
                                <div class="common-right-column">
                                    <div class="view-all-items-block">
                                        <h3 class="your-items-title">Your Images
                                            <a href="{{ url('/user-images') }}" class="view-all-btn">(View All)</a>
                                        </h3>
                                        <ul class="all-items-list">
                                            @foreach ($user_media as $user_medias)
                                                <li>
                                                    <a href="{{ url('/image-detail/' . $user_medias->media_id) }}">
                                                        <img src="{{ $user_medias->mediumthumbimagefilepath }}" alt="Photos">
                                                    </a>
                                                </li>
                                            @endforeach
                                        </ul>
...
@section('page-scripts')
    ...
    <script src="{{ asset_front('/js/profile/uploadimage.js?ver=' . mt_rand(1000, 9999)) }}"></script>
@endsection
