...
function loadData(page, search) {
    showLoader();
    ajaxFetch(baseurl() + '/admins/load', { page: page, search: search }, formResponse);
}
...
function deleteEntity(adminid) {
	showModal();
	confirmDialoue("Delete", 'Are you sure you want to delete this admin?', function(e){
		if (e) {
			ajaxUpdate(baseurl() + '/admins/destroy', { adminid: adminid }, function(responseText, statusText) {
				hideLoader();
				if(statusText == 'success') {
